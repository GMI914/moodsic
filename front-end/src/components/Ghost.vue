<template>
    <div class="ghost-animation">
        ...
        <p class="shadowFrame">
            <svg version="1.1" class="shadow" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                 xmlns:xlink="http://www.w3.org/1999/xlink" x="61px" y="20px"
...
.ghost-animation .shadowFrame {
    width: 130px;
    margin: 15px auto 0;
}

.ghost-animation .shadow {
    animation: shrink 3s ease-out infinite;
    transform-origin: center center;
}

.ghost-animation ellipse {
    transform-origin: center center;
}
